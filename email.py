...
mail_user = "3592223856@qq.com"  # 用户名
mail_pass = "hht190416"  # 口令
...
att1 = MIMEText(r'D:\Python学习\python作业\计算机.html', 'base64', 'utf-8')
...
mail_content = {
    'subject': '!',  # 随便填写
    'content_text': '!',  # 随便填写
    'attachments': ['D:\\Python学习\\python作业\\计算机.html'],
}

# 使用你的邮件账户名和密码登录服务器
server = zmail.server('3592223856@qq.com', 'hht190416')
# 发送邮件
